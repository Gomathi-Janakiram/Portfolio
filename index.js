...
function socialIconListners() {
  ...
  $("#github-profile").on("click", function (event) {
    ...
    window.open("https://github.com/Gomathi-Janakiram", "github");
  });
  $("#linkedin-profile").on("click", function (event) {
    event.preventDefault();
    window.open(
      "https://www.linkedin.com/in/gomathi-janakiram-ab75041a0/",
      "linkedin"
    );
  });
  $("#gmail-send").on("click", function (event) {
    event.preventDefault();
    window.open(
      "https://mail.google.com/mail/u/0/?view=cm&fs=1&to=gomathirengavilas@gmail.com&tf=1",
      "gmail"
    );
  });
}
